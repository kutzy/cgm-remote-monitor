...
function init (client, plugins, serverSettings, $) {
  ...
  function loadForm ( ) {
    ...
    $('#calib-slope-browser').val(settings.calibSlope);
    $('#calib-intercept-browser').val(settings.calibIntercept);
  ...
  function wireForm ( ) {
    ...
    $('#save').click(function(event) {
      ...
      storeInBrowser({
        ...
        calibIntercept: parseFloat($('#calib-intercept-browser').val()) || 0,
        calibSlope: parseFloat($('#calib-slope-browser').val()) || 1,
